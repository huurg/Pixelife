...
void LC_MenuBar::init() {
    ...
    // Create tool 1 button
    {
        ...
        this_button->setColour(128,128,128,255,LC_CLICKABLE_STATE_OVER);
        this_button->setColour(64,64,64,255,LC_CLICKABLE_STATE_DOWN);
        this_button->setImage("./res/createterrain.bmp",255);
    ...
    // Create tool 2 button
    {
        ...
        this_button->setColour(128,128,128,255,LC_CLICKABLE_STATE_OVER);
        this_button->setColour(64,64,64,255,LC_CLICKABLE_STATE_DOWN);
        this_button->setImage("./res/eraseterrain.bmp",255);
    ...
    // Create tool 3 button
    {
        ...
        this_button->setColour(128,128,128,255,LC_CLICKABLE_STATE_OVER);
        this_button->setColour(64,64,64,255,LC_CLICKABLE_STATE_DOWN);
        this_button->setImage("./res/createherb.bmp",255);
    ...
    // Create tool 4 button
    {
        ...
        this_button->setColour(128,128,128,255,LC_CLICKABLE_STATE_OVER);
        this_button->setColour(64,64,64,255,LC_CLICKABLE_STATE_DOWN);
        this_button->setImage("./res/eraseherb.bmp",255);
