...
constexpr char* LC_MENUBAR_STOPBUTTON_IMAGE = "./res/stop.bmp";
constexpr char* LC_MENUBAR_PLAYBUTTON_IMAGE = "./res/play.bmp";
constexpr char* LC_MENUBAR_STEPBUTTON_IMAGE = "./res/step.bmp";
